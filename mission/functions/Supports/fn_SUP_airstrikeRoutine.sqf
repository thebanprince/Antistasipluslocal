...
[2, "Fly height ASL: %1 | Target hight: %2", _minAltASL, _targetPos, _filename] call A3A_fnc_log;
...
if (time >_timeOut) then {
    [2, format ["Plane for %1 did not return before timeout", _supportName], _filename] call A3A_fnc_log;
